...
DawnDevice/icm206xx.o: C:/Users/leonardo/Desktop/Code/Github/DawnGBC/Dawn/DawnDevice/icm206xx.c DawnDevice/subdir.mk
	@echo '正在构建文件： $<'
...
clean: clean-DawnDevice

clean-DawnDevice:
	-$(RM) ./DawnDevice/icm206xx.d ./DawnDevice/icm206xx.o

.PHONY: clean-DawnDevice
